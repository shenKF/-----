    ...
    if (self) {
        ...
        if (albums == nil) {
            albums = [NSMutableArray arrayWithArray:@[
                                                      ...
                                                      [[Album alloc] initWithTitle:@"Tt's My Life" artist:@"No Doubt" coverUrl:@"http://www.coversproject.com/static/thumbs/album/album_no%20doubt_its%20my%20life%20%20bathwater.png" year:@"2003"],
...
{
    filiname =[NSHomeDirectory() stringByAppendingFormat:@"/Documents/%@",filiname];
    NSData *data = [NSData dataWithContentsOfFile:filiname];
